...
/* ---------------------------------------------------------------------- */
/*  بيانات أولية (تُستخدم فقط إذا كانت المنصة فارغة عند أول تشغيل)          */
/* ---------------------------------------------------------------------- */
...
const SEED_ARTICLES = [
  {
    id: 'a1',
    title: 'حين يكتب الذكاء الاصطناعي: من يملك الفكرة؟',
    subtitle: 'بين الأداة والمؤلف، خط رفيع أعادت النماذج اللغوية رسمه من جديد',
    cover: 'https://picsum.photos/seed/midad-ai/1200/700',
    tags: ['تقنية'],
    author: 'مريم الجابري',
    authorBio: 'كاتبة تقنية مهتمة بالتقاطع بين الأدوات الذكية والإبداع الإنساني.',
    createdAt: '2026-08-22',
    claps: 214,
    body: `منذ أن بدأت النماذج اللغوية تكتب فقرات متماسكة، تغيّر سؤال قديم: من يملك النص؟ الكاتب الذي صاغ الفكرة الأولى، أم الأداة التي رتّبت الكلمات؟\n\n## أداة لا بديل\n\nالفرق الجوهري أن هذه النماذج لا تملك تجربة تعيشها، ولا ذاكرة تحمل أثر الزمن. هي تعيد ترتيب ما تعلّمته من نصوص سبقتها، بينما يبقى القرار الإبداعي - ماذا نقول، ولمن، ولماذا - قرارًا بشريًا في جوهره.\n\n> الكتابة ليست فقط اصطفاف جمل صحيحة، بل اختيار ما يستحق أن يُقال أصلًا.\n\n## ما الذي تغيّر فعلًا\n\nما تغيّر ليس معنى الكتابة، بل سرعة الوصول إلى المسودة الأولى. الكاتب اليوم يبدأ من نقطة أبعد، لكنه لا يزال المسؤول عن الصوت والدقة والمعنى.\n\nثلاثة أسئلة يطرحها كل كاتب جاد على نفسه قبل نشر نص استعان فيه بأداة ذكاء اصطناعي:\n\n- هل هذا الصوت يشبهني، أم يشبه الأداة؟\n- هل تحققت من كل معلومة وردت في النص؟\n- هل أضفت شيئًا لم يكن ليوجد لولا خبرتي أنا؟\n\nحين تكون الإجابة نعم على الأسئلة الثلاثة، تبقى الفكرة ملكًا لصاحبها، مهما كانت الأداة التي ساعدته على صياغتها.`,
    comments: [
      { id: 'c1', author: 'خالد العتيبي', text: 'مقال متوازن، خاصة النقطة الأخيرة عن الأسئلة الثلاثة.', createdAt: '2026-08-23' },
      { id: 'c2', author: 'هدى النعيمي', text: 'أتفق تمامًا، السرعة تغيرت لا المسؤولية.', createdAt: '2026-08-24' }
    ]
  },
  {
    id: 'a2',
    title: 'البساطة كقرار، لا كمظهر',
    subtitle: 'لماذا يخطئ أغلبنا حين يظن أن التصميم البسيط يعني تصميمًا سهلًا',
    cover: 'https://picsum.photos/seed/midad-design/1200/700',
    tags: ['تصميم'],
    author: 'سلمى خالد',
    authorBio: 'مصممة منتجات تعمل على تبسيط الواجهات المعقدة منذ ثماني سنوات.',
    createdAt: '2026-08-18',
    claps: 356,
    body: `كل تصميم بسيط أمامك هو نتيجة عشرات القرارات الصعبة التي اتُّخذت خلف الكواليس. البساطة ليست غياب العناصر، بل غياب كل عنصر لا يخدم غرضًا واضحًا.\n\n## الفخ الشائع\n\nيقع كثير من المصممين في فخ الحد الأدنى الشكلي: مساحات بيضاء واسعة، وخط واحد، وألوان محايدة - لكن دون أن يجيبوا فعليًا عن سؤال: ما الذي يحتاجه المستخدم في هذه اللحظة بالضبط؟\n\n> التبسيط الحقيقي يبدأ بالحذف، لا بالتزيين.\n\nحين تصمم شاشة جديدة، جرّب أن تسأل عن كل عنصر فيها: ماذا يحدث لو حذفته؟ إن كانت الإجابة لا شيء يُذكر، فربما كان وجوده أصلًا زائدًا.\n\n## البساطة تكلفة وقت\n\nالمفارقة أن الوصول إلى تصميم بسيط يستغرق وقتًا أطول من تصميم معقّد. التعقيد سهل، لأنه لا يتطلب قرارات حاسمة. أما البساطة فتتطلب أن تعرف بدقة ما تريد قوله، ثم تقوله بأقل عدد ممكن من الكلمات أو العناصر.`,
    comments: [
      { id: 'c3', author: 'عمر الفهد', text: 'جملة "التبسيط يبدأ بالحذف لا بالتزيين" تستحق أن تُعلّق على الجدار.', createdAt: '2026-08-19' }
    ]
  },
  {
    id: 'a3',
    title: 'يوم بلا إشعارات',
    subtitle: 'تجربة شخصية مع أسبوع كامل من العزلة الرقمية، وما تعلمته منها',
    cover: 'https://picsum.photos/seed/midad-life/1200/700',
    tags: ['حياة'],
    author: 'لينا حداد',
    authorBio: 'كاتبة مقالات شخصية، تكتب عن العادات اليومية وعلاقتنا بالوقت.',
    createdAt: '2026-08-25',
    claps: 189,
    body: `في اليوم الأول، شعرت بقلق غريب كلما وصلت يدي إلى الهاتف دون سبب. لم يكن هناك إشعار ينتظرني، لكن العادة كانت أقوى من الحاجة الفعلية.\n\nقررت إيقاف كل الإشعارات لمدة أسبوع، لا الهاتف نفسه، فقط الأصوات والومضات التي تقاطع كل فكرة قبل أن تكتمل.\n\n## ما لاحظته\n\nبحلول اليوم الثالث، بدأت أنتبه لأشياء كنت أمر عليها دون رؤيتها فعلًا: طول الطريق إلى العمل، حديث زميل كان يحاول إخباري بشيء مهم، فكرة كتابة كانت تنتظر منذ أسابيع.\n\nلم يكن الأمر عن الهاتف بقدر ما كان عن استعادة القدرة على إنهاء فكرة واحدة قبل أن تبدأ التالية.\n\n## بعد الأسبوع\n\nلم أعد كل الإشعارات كما كانت. أبقيت فقط ما يحتاج فعلًا إلى استجابة فورية، وأرجأت كل ما عداه إلى وقت أختاره أنا، لا وقت يفرضه التطبيق.`,
    comments: []
  },
  {
    id: 'a4',
    title: 'ماذا تخبرنا الثقوب السوداء عن حدود المعرفة؟',
    subtitle: 'رحلة قصيرة في المنطقة التي تتوقف عندها فيزياء أينشتاين عن الإجابة',
    cover: 'https://picsum.photos/seed/midad-space/1200/700',
    tags: ['علوم'],
    author: 'يوسف مراد',
    authorBio: 'باحث في الفيزياء الفلكية، يكتب لتقريب المفاهيم المعقدة من القارئ العام.',
    createdAt: '2026-08-15',
    claps: 421,
    body: `عند مركز كل ثقب أسود، تتوقف معادلات آينشتاين عن إعطائنا إجابات منطقية. الكثافة تصبح لا نهائية، والزمن نفسه يفقد معناه المعتاد. هذه النقطة تسمى "المتفردة"، وهي أحد أكثر الألغاز إثارة في الفيزياء الحديثة.\n\n## أفق الحدث\n\nحول كل ثقب أسود توجد منطقة تسمى "أفق الحدث"، وهي الحد الذي بعده لا يمكن لأي شيء - ولا حتى الضوء - أن يفلت من الجاذبية. من الخارج، لا نرى ما بداخل هذا الأفق، بل فقط أثره على ما حوله.\n\n> ما لا نستطيع رؤيته مباشرة، نتعلم عنه من الطريقة التي يُغيّر بها كل شيء من حوله.\n\n## لماذا يهمنا هذا\n\nدراسة الثقوب السوداء ليست ترفًا علميًا بعيدًا عن حياتنا. هي اختبار حقيقي لحدود فهمنا للجاذبية والزمن والمكان، وكل تقدم في فهمها يقربنا خطوة من نظرية أشمل تجمع بين ميكانيكا الكم والنسبية العامة، وهو أحد أكبر الأسئلة المفتوحة في الفيزياء اليوم.`,
    comments: [
      { id: 'c4', author: 'ريم صالح', text: 'أفضل شرح مبسط لمفهوم أفق الحدث قرأته حتى الآن.', createdAt: '2026-08-16' }
    ]
  },
  {
    id: 'a5',
    title: 'الشعر حين يفقد وزنه: قراءة في قصيدة النثر العربية',
    subtitle: 'كيف تخلّت القصيدة عن البحور دون أن تفقد إيقاعها الداخلي',
    cover: 'https://picsum.photos/seed/midad-culture/1200/700',
    tags: ['ثقافة'],
    author: 'نور الدين قاسم',
    authorBio: 'ناقد أدبي، متخصص في الشعر العربي الحديث وقصيدة النثر.',
    createdAt: '2026-08-10',
    claps: 132,
    body: `حين ظهرت قصيدة النثر في منتصف القرن الماضي، قوبلت بمقاومة شديدة. كيف يكون النص شعرًا دون وزن ولا قافية؟ كان السؤال نفسه اعترافًا ضمنيًا بأن الشعر أكبر من قواعده الشكلية.\n\n## الإيقاع الداخلي\n\nما فقدته قصيدة النثر من الوزن الخارجي، عوّضته بإيقاع داخلي: تكرار الصور، توازن الجمل، والمسافة المدروسة بين كلمة وأخرى. القارئ لا يسمع بحرًا عروضيًا، لكنه يشعر بنبض ما، لو حاول تفسيره لعجز.\n\nهذا لا يعني أن كل نثر مقطّع إلى أسطر هو قصيدة. الفارق يكمن في الكثافة: كل كلمة في القصيدة الجيدة تحمل وزنًا لا يمكن حذفه دون أن ينهار المعنى.\n\n## سؤال الشرعية\n\nاليوم، تجاوز النقاش سؤال الشرعية إلى سؤال الجودة: لم يعد السؤال هل قصيدة النثر شعر، بل أي قصائد نثر تستحق أن تبقى.`,
    comments: []
  },
  {
    id: 'a6',
    title: 'لماذا تفشل أغلب المشاريع الناشئة في أول عامين؟',
    subtitle: 'ليس نقص التمويل هو السبب الأول، كما يظن كثيرون',
    cover: 'https://picsum.photos/seed/midad-business/1200/700',
    tags: ['أعمال'],
    author: 'مريم الجابري',
    authorBio: 'كاتبة تقنية مهتمة بالتقاطع بين الأدوات الذكية والإبداع الإنساني.',
    createdAt: '2026-08-05',
    claps: 278,
    body: `حين تُسأل عن سبب فشل المشاريع الناشئة، يجيب أغلب الناس بسرعة: نفاد التمويل. لكن الدراسات المتكررة على مدى عقد تشير إلى سبب أكثر شيوعًا: عدم وجود حاجة حقيقية في السوق لما بُني.\n\n## بناء الحل قبل فهم المشكلة\n\nكثير من المؤسسين يقعون في حب فكرتهم قبل أن يختبروها. يبنون منتجًا كاملًا، ثم يبحثون عن من يحتاجه، بدل أن يبدأوا من مشكلة حقيقية يعيشها ناس حقيقيون، ثم يبنوا أصغر حل ممكن لها.\n\n> المنتج الرائع لمشكلة لا يشعر بها أحد، لا يساوي شيئًا في السوق.\n\n## العلامات المبكرة\n\nهناك إشارات مبكرة تكشف أن المشروع يسير في الاتجاه الخاطئ:\n\n- المستخدمون يجربون المنتج مرة واحدة ولا يعودون إليه\n- فريق المبيعات يحتاج إلى إقناع طويل لكل عملية بيع\n- لا أحد يوصي بالمنتج لصديق دون أن يُطلب منه ذلك\n\nحين تظهر هذه العلامات مبكرًا، الخيار الأصعب - والأصح غالبًا - هو تغيير الاتجاه قبل أن ينفد الوقت، لا بعده.`,
    comments: [
      { id: 'c5', author: 'فيصل الدوسري', text: 'النقطة الثالثة في القائمة هي المقياس الحقيقي برأيي.', createdAt: '2026-08-06' }
    ]
  }
];

const ALL_TAGS = ['تقنية', 'تصميم', 'حياة', 'علوم', 'ثقافة', 'أعمال'];
